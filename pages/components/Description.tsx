  ...
  return (
    <div className="mt-10 flex flex-col gap-4 items-center p-8 sm:p-0">
      ...
      <p className="max-w-xl font-bold text-center">
        A Computer Engineering graduate with experience in Web Development.
        Loves challenges as much as solving them through critical ways of
        thinking and great ideas. A self-learner and curious person who is very
        communicative.
      </p>
      <div className="flex gap-4">
        <a
          href="https://www.linkedin.com/in/mtaufiqmahdi/"
          target="_blank"
          className="rounded-full p-3 bg-slate-300 hover:shadow-lg hover:scale-125 duration-500"
        >
          <svg
            height="25px"
            width="25px"
